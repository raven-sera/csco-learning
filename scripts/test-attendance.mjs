...
const base = { kind:'口头报告', scheduleCategory:'主日程', program:'', session:'', abstractNo:'', sourceTitle:'肺癌真实世界研究', speaker:'报告人', institution:'医院', dateTime:'2026-09-17 上午 09:00-09:15', field:'肺癌', directions:['真实世界/回顾性/数据库'], officialUrl:'', searchAliases:'' };
const reports = [
  { ...base, id:1, location:'山东大厦 一楼 孔膳厅' },
  { ...base, id:2, location:'山东大厦 一层 孔膳厅' },
  { ...base, id:3, location:'山东大厦 二层 海右泺源厅', field:'大会专题', directions:['汇报分享'], sourceTitle:'会议总结' },
  { ...base, id:4, location:'南郊宾馆俱乐部 四层 小礼堂', field:'乳腺癌', directions:[], sourceTitle:'乳腺癌治疗' },
  { ...base, id:5, location:'山东大厦 二层 济南厅', dateTime:'2026-09-18 上午 09:00-09:15', field:'核医学/分子影像', directions:[], sourceTitle:'核医学与PET-CT进展' },
  { ...base, id:6, location:'山东大厦 一层 中泰证券厅', field:'大会专题', directions:['汇报分享'], sourceTitle:'会议总结' },
];
...
assert.equal(stats.keywords.find(keyword => keyword.label === '肺癌').count, 2, 'The same title and metadata keyword counts once per report');
...
assert.ok(!stats.keywords.some(keyword => keyword.label === '大会专题' || keyword.label === '汇报分享'), 'Generic schedule classifications are not interests');
