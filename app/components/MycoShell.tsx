...
type IconName = 'search' | 'bookmark' | 'calendar' | 'library' | 'map' | 'atlas' | 'download' | 'arrow' | 'menu' | 'close' | 'shield';
...
const PAGES = [
  ...
  { id: 'atlas', href: '/atlas', label: '打卡图鉴', icon: 'atlas' },
] as const;
...
const ICON_PATHS: Record<IconName, string> = {
  ...
  atlas: 'm21 3-7 18-3-8-8-3L21 3Zm0 0L11 13',
...
export default function MycoShell({ activePage, fitViewport = false, favoriteCount, scheduleCount, libraryCount, onMap, attendanceCount, onExport, children }: MycoShellProps) {
  ...
  const counts = { favorites: favoriteCount, schedule: scheduleCount, library: libraryCount, atlas: attendanceCount };
