...
export function createCalendarFile(reports: readonly Report[], now = Date.now()) {
  const lines = ['BEGIN:VCALENDAR', 'VERSION:2.0', 'PRODID:-//Huidu//CSCO 2026//ZH', 'CALSCALE:GREGORIAN', 'METHOD:PUBLISH'];
...
export function downloadCalendar(reports: readonly Report[]) {
  ...
  link.href = url; link.download = 'CSCO2026-我的日程.ics'; link.click();
